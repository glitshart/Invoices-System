        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                        ...
                        class="badge badge-success side-badge">4</span></a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                    </svg><span class="side-menu__label">التقسيمات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">الاقسام</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'products')) }}">المنتجات</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'profile')) }}">تنظيف الفواتير</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'editprofile')) }}">تنظيف الأقسام</a></li>
                </ul>
            </li>
        </ul>
    </div>
